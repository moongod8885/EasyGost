...
> 脚本简介
> > 适合懒人的超简单gost一键转发脚本:  
> > 备用`wget --no-check-certificate -O gost.sh https://raw.githubusercontent.com/BlueSkyXN/EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh` 
> > 
> > 执行`wget --no-check-certificate -O gost.sh https://raw.githubusercontent.com/moongod8885/EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh` 
